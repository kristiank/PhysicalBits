...
var TRANSLATIONS = [
  ...
  ["Download...", "Download...", "Descargar...", "Laadi alla...", "Ladda ned..."],
  ...
  ["Echo pin", "Echo pin", "Pin Echo", "Kajaanduri (mikrofoni) viik", "Mikrofonens ben"],
  ...
  /* "read distance from sonar %name in units %unit" */ ["%name . %unit ()", "read distance from %name in %unit", "leer distancia de %name en %unit", "mõõdetud kaugus kajaloost %name ühikutes %unit", "läs avståndet från ekolodet %name i %unit"],
